...
num_epochs = 1
model_save_path = data_folder + '/../models-bm25-cat/train-cross-encoder-kd-bm25cat-ms-marco-TinyBERT-L-2-bastsize-'+train_batch_size+'lr-'+learning_rate+'-'+model_name.replace("/", "-")+'-'+datetime.now().strftime("%Y-%m-%d_%H-%M-%S")
