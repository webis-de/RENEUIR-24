...
from sentence_transformers.cross_encoder.CrossEncoder import SentenceTransformer, util
from sentence_transformers.cross_encoder.CrossEncoder import SentenceEvaluator
from sentence_transformers.cross_encoder.CrossEncoder import get_device_name
    ...
    def _eval_during_training(self, evaluator, output_path, save_best_model, epoch, steps, callback):
        ...
        if evaluator is not None:
            ...
            if score > self.best_score:
                ...
                self.count_round_stopping += 1
            # early stopping condition
            if score < self.best_score * 0.995 and self.count_round_stopping > 3:
                self.count_round_stopping += 1
                if self.count_round_stopping >= 3:
