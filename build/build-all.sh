...
docker build -t tiny-bert-ranker-distillation -f tiny-bert-ranker-distillation/Dockerfile --build-arg MODEL_NAME=webis/tiny-bert-ranker-distillation .
docker build -t tiny-bert-ranker-l-2-distillation -f tiny-bert-ranker-distillation/Dockerfile --build-arg MODEL_NAME=webis/tiny-bert-ranker-l-2-distillation .
