...
docker build -t tiny-bert-ranker-bm25 -f code/Dockerfile.tinybertcatbm25  --build-arg MODEL_NAME=webis/tiny-bert-ranker-bm25 .
docker build -t tiny-bert-ranker-l2-bm25 -f code/Dockerfile.tinybertcatbm25  --build-arg MODEL_NAME=webis/tiny-bert-ranker-l2-bm25 .
